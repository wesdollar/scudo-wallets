...
const ReturnPolicy = () => (
  <React.Fragment>
    <Helmet>
      <title>{routes.returnPolicy.metaTitle}</title>
    </Helmet>
    <Content>
      <h1>Return Policy</h1>
      <p>
      ...
      <ul>
        ...
        <li>
          Pay return shipping; we do not refund any shipping costs, including
          the original shipping fees (some exceptions apply)
        </li>
