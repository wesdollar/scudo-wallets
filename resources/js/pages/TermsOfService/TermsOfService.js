...
const TermsOfService = () => (
  <Content>
    ...
    <p style={{ textTransform: "uppercase" }}>Overview</p>
    <p>
      This website is operated by MGW {app.scudo}. Throughout the site, the
      terms &quot;we&quot;, &quot;us&quot; and &quot;our&quot; refer to MGW{" "}
      {app.scudo}. MGW {app.scudo} offers this website, including all
    ...
    <p>
      ...
      of the site, including without limitation users who are browsers, vendors,
    ...
    <p>
      ...
      third-party&apos; policies and practices and make sure you understand them
    ...
    <p>
      ...
      our Privacy Policy. To view our Privacy Policy, please see: Privacy
      Policy.
    </p>
    ...
    <p>
      ...
      &apo;as is&apo; and &apo;as available&apo; for your use, without any
    ...
    <p>
      In no case shall MGW {app.scudo}, our directors, officers, employees,
    ...
    <p>
      You agree to indemnify, defend and hold harmless MGW {app.scudo} and our
    ...
    <p>
      Questions about the Terms of Service should be sent to us at {app.email}.
    </p>
    <ContactUs />
  </Content>
);
