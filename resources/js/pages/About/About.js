...
const About = () => {
  ...
  const whatNotToExpect = [
    ...
    "We offer ground UPS for domestic orders and US mail for overseas or Canadian orders. We do not upcharge our shipping for foreign orders but pricing varies so greatly that there is no way to know each shipping cost online. If you are concerned about shipping costs please call in your order. We only charge what the post office charges us!",
    ...
    <React.Fragment>
      <Content>
        ...
        <p>
          ...
          arms parts and sighting systems for the armed forces and large
          firearms manufacturers such as Sig Sauer, Glock, Beretta and Trijicon.
        </p>
        <p>
          ...
          While still largely focused on the manufacturing of firearms
