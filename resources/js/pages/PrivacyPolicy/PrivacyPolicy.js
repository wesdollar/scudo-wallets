...
const PrivacyPolicy = () => (
  <Content>
    ...
    <p>
      ...
      order, subscribe to a newsletter, respond to a survey, fill out a form or
    ...
    <p>
      For your convenience we may store your credit card information longer than
    ...
    <p>
      ...
      browser (like Chrome) settings. Each browser is a little different, so
      look at your browser&apos;s Help menu to learn the correct way to modify
      your cookies.
    </p>
    <p>
      <strong>
        Some features of our website may not work if you disable cookies.
      </strong>{" "}
      If you experience issues after disabling cookies, you may place an order
    ...
    <p>
      We reserve the right to include or offer third party products or services
      on our website. We will clearly identify links to third parties and/or
      third party products on our website.
    </p>
    <h4>Google</h4>
    <p>
    ...
    <p>
      At our discretion, we may utilize Google&apos;s AdSense services to meet
      some of our online marketing needs. Some anonymous data that could be used
      to uniquely identify you may be transmitted and/or stored to Google&apos;s
      services. For more information on how Google utilizes anonymous data,
      please Google it!
    </p>
    <p>
    ...
    <p>
      ...
      visiting the Network Advertising initiative opt out page or permanently
    ...
    <p>
      Users are able to change their personal information by emailing or calling
      us.
    </p>
    ...
    <p>
      ...
      behavioral tracking. This means that we do not allow any third party
      services, such as online marketing & advertising providers, to monitor and
      track how you use our website. We understand the value of your privacy; we
      have invested significant resources into protecting your data.
    </p>
    ...
    <p>
      <strong>
        We do not specifically market to children under 13, intentionally or
        otherwise.
      </strong>
    </p>
    ...
    <p>
      We adhere to the Fair Information Practices. We encrypt your personal
      information using a combination of encryption algorithms to ensure that
      your information is kept safe and secure. Although highly unlikely, it is
      possible for an unauthorized person to gain access to the data stored in
      any of our databases. All sensitive information contained within any
      database is encrypted prior to being saved to the database making it
      practically impossible to read the data in plain text as it was originally
      entered into said database. In the event of a data breach, we will notify
      all users via email within seven (7) business days. We will also post a
      notification on the homepage of our website within seven (7) business
      days.
    </p>
    <p>
    ...
    <ul>
      <li>NOT use false or misleading subjects.</li>
      <li>
    ...
    <p>
      ...
      from MGW Scudo, you may do so by:
    </p>
    <ul>
      <li>Following the instructions provided at the bottom of each email.</li>
      <li>Calling us during normal business hours.</li>
      <li>
        Sending an email to {app.email}. Requests sent to {app.email} may take
        up to 45 days to be removed.
      </li>
    </ul>
    <h4>Contacting Us</h4>
    <p>
      Your privacy is extremely important to us. If there are any questions
      regarding this privacy policy, please feel free to contact us at any time.
    </p>
    <ContactUs />
  </Content>
);
