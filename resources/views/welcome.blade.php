...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Scudo Wallets - built slim, light, and made to hold everything important in your life. A design perfected to fit into your life.">
